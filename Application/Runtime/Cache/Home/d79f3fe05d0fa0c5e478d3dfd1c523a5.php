        ...
        <div class="m-inputs">
            ...
            <div class="item">
                ...
                <select name="hometown" id="" class="select_cahnge js-c_way">
                    <option value="上海">光电</option>
                    <option value="天津">计算机</option>
                    <option value="重庆">通信</option>
                    <option value="黑龙江">生物</option>
            ...
            <div class="item">
                ...
                <div class="de_label">
                    ...
                    <i class="s-arrow"></i></div>
                <select name="connect" id="" data-tag="spec" class="select_cahnge js-c_way">
            ...
            <div class="upload_img js-up_hcon">上传图片</div>
        </div>
    </form>
</div>
</body>
